  ...
  return (
    <aside className="w-64 h-screen gradient-sidebar border-r border-sidebar-border flex flex-col">
      ...
      <div className="p-4 border-t border-sidebar-border space-y-1">
        <Link
          to="/help"
          className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground transition-colors"
        >
        ...
        <Button
          ...
          className="w-full justify-start gap-3 px-4 py-2 h-auto text-sm text-sidebar-foreground/70 hover:bg-destructive/10 hover:text-destructive"
        >
