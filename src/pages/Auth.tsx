        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-white/80">
              A plataforma inteligente para gestores de saúde criarem conteúdo relevante para suas redes sociais.
            </p>
          </div>
          ...
          <div className="grid gap-4">
            <div className="flex items-start gap-4 bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Monitore as principais notícias e insights do setor de saúde</p>
              </div>
            </div>
