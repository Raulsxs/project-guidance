      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Plataforma SaaS que monitora tendências do setor de saúde e gera automaticamente 
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard 
              ...
              description="Coletamos automaticamente as principais notícias e tendências do setor de saúde de fontes confiáveis."
            />
            <FeatureCard 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-6">
                Feito para Gestores de Saúde
              </h2>
              <div className="space-y-4">
                <BenefitItem 
                  icon={<Target className="w-5 h-5 text-primary" />}
                  text="Conteúdo especializado para o setor de gestão em saúde"
                />
                <BenefitItem 
                  icon={<Target className="w-5 h-5 text-primary" />}
      ...
      <section className="py-20 px-6 bg-gradient-primary">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Junte-se a centenas de gestores de saúde que já estão economizando tempo e gerando mais engajamento.
          </p>
          <Button 
            size="lg" 
            variant="secondary" 
